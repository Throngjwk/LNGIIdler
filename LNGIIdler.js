...
var id = "lngi_idler";
var name = "LNGI Idler";
var description = "Thanks to LNGI Incremental is created by Katakana.";
var authors = "Karen";
var version = 1;
...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(1, currency, new ExponentialCost(5, Math.log2(10)));
...
var getPublicationMultiplier = (tau) => tau.pow(0.502) / BigNumber.THREE;
